...
ActiveRecord::Schema.define(version: 20150312032441) do
  ...
  add_index "cat_rental_requests", ["requestor_id"], name: "index_cat_rental_requests_on_requestor_id", using: :btree
